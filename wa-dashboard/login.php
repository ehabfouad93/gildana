 ...
 * Sign in.
 *
 * Split out of index.php when that became the public landing page. Everything that needs a
 * signed-in user sends people here, so this is the one URL that must never be a marketing
...
<body class="login-screen">
  <form class="login-card" method="post">
    ...
    <p class="login-back"><a href="index.php">&larr; Back to <?= e($appName) ?></a></p>
  </form>
<?= pwa_script('./') ?>
</body>
</html>
